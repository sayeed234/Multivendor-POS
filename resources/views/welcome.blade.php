...
<head>
  ...
  <title>LS Soft || Software Service in Bangladesh</title>
    ...
    <div class="bg-color">
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a href="{{url('/')}}" class="navbar-brand">LS Soft</a>
            </div>
            ...
            <li><a href="{{url('/mydashboard')}}">Dashboard</a></li>
               @else 
      ...
      <div class="container text-center">
        <div class="wrapper wow fadeInUp delay-05s">
          <h2 class="top-title">TV, Mobile,Refrigerator & Bike Showroom</h2>
          <h3 class="title">Service</h3>
          <h4 class="sub-title">We Create amazing Calculate</h4>
          <button type="submit" title="01318-712782" class="btn btn-submit">Call</button>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="cta-info text-center">
          <h3><span class="dec-tec">“</span>সত্যিকারের জীবন প্রতিযোগিতার জীবন নয়, সত্যিকারের জীবন হচ্ছে সহযোগিতার <span class="dec-tec">”</span></h3>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">Regular & EMI Sale</h3>
          ...
          <div class="col-md-6 wow fadeInRight delay-02s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">Unlimited Customer Profile</h3>
              <p class="txt-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula felis euismod semper. </p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-04s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">Easy To Sale Calculate</h3>
              <p class="txt-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula felis euismod semper. </p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-04s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">Stock Maintain </h3>
              <p class="txt-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula felis euismod semper. </p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-06s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">All Type Report Print</h3>
              <p class="txt-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula felis euismod semper. </p>
            </div>
          </div>
          <div class="col-md-6 wow fadeInRight delay-06s">
            ...
            <div class="icon-text">
              <h3 class="txt-tl">Highly Secured</h3>
              <p class="txt-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula felis euismod semper. </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12">
          ...
          <div class="col-md-4 col-sm-6">
            ...
            <div class="location-info">
              <p class="white"><span aria-hidden="true" class="fa fa-map-marker"></span>Omar Plaza 4th Floor Rajshahi</p>
              <p class="white"><span aria-hidden="true" class="fa fa-phone"></span>Phone: 01318712782</p>
              <p class="white"><span aria-hidden="true" class="fa fa-envelope"></span>Email: <a href="" class="link-dec">nurul.sayeed.dev@gmail.com</a></p>
            </div>
          </div>
          <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-sm-7 footer-copyright">
          ...
          <div class="credits">
            ...
            -->
            Designed by <a href="https://bootstrapmade.com/">LS Soft</a>
          </div>
        </div>
