@extends('user.master')
@section('title')
Sale Report ||  {{Session::get('name')}}
@endsection
@section('content')
 <div class="ibox"style="margin-top: 5px;">            
<div class="ibox-head">
<div class="card-body">                                           
<form action="{{url('/sale_report')}}" method="get"> 
        @csrf   
            <div class="row">
                <div class="col-md-6 ">
                    <div class="row">
 ...
 <div class="card-header">
    <div class="row">
        <div class="col-md-6"><h6 class="m-0 font-weight-bold ">Sales Report For @if($todate==0) Today @else{{$fromdate}} --- {{$todate}}  @endif</h6></div>    
