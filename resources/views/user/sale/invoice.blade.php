@extends('user.master')
@section('title')
Invoice Order || {{Session::get('name')}}
@endsection
@section('content')
<br>
        ...
        <div class="row">
          ...
          <?php   $company=DB::table('admins')->where('id',Session::get('ID'))->first(); ?>
           ...
           <hr>
              ...
              <div class="row">
               @if($order->status=="EMI")
               <p class="lead">Your Payment Summery</p><br>
          ...
          @else
             <div class="col-6">                  
                ...
                <div class="col-md-6 col-12">
                  <p class="lead">Your Payment Summery</p>
            ...
            @endif
              ...
              <div class="row no-print">
                ...
                <div class="row">
                 <div class="col-3">
                        <a href="{{url('/product_view/all')}}"><button class="btn btn-danger">Home</button></a>
                     </div>
                      <div class="col-6 ">
                       </div>
                 <div class="col-3 ">
